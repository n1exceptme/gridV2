Ext.define('ExtPOD.view.fornitura.FornitureGrid' ,{
	...
	columns: [
				...
				{text: 'Modalità<br>di lettura', dataIndex: 'lettura', hidden: true, sortable: true, width:120, align:'center'},
				{text: 'Modalità<br>accensione', dataIndex: 'accensione', hidden: true, sortable: true, width:120, align:'center'},
				{
				...
				{text: 'Modalità<br>consegna', dataIndex: 'consegna', hidden: true, sortable: true, width:120, align:'center'},				
